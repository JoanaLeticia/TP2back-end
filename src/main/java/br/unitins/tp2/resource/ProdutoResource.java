...
public class ProdutoResource {
    ...
    public PaginacaoResponse<ProdutoResponseDTO> buscarTodos(
        ...
        List<ProdutoResponseDTO> produtos = service.findAll(page, pageSize, sort);
    ...
    @Path("/nome/{nome}")
    @RolesAllowed({ "Admin" })
    public PaginacaoResponse<ProdutoResponseDTO> buscarPorNome(
        @PathParam("nome") String nome,
        @QueryParam("page") @DefaultValue("0") int page,
        @QueryParam("page_size") @DefaultValue("10") int pageSize,
        @QueryParam("sort") @DefaultValue("id") String sort) {
        
        List<ProdutoResponseDTO> produtos = service.findByNome(nome, page, pageSize, sort);
